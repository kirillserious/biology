...
\subsection{Модель пищевой цепи}
\(
	\begin{cases}
	\dot{u_1} = u_1(r_1 - a_{1,2}u_2 - a_{1,1}u_1) = u_1w_1(u)
	\\
	\dot{u_2} = u_2(-r_2 + a_{2,1}u_1 - a_{2,3}u_3 - a_{2,2}u_2 ) = u_2w_2(u)
	\\
	.....
	\\
	\dot{u_k} = u_k(-r_k + a_{k,k-1}u_{k-1} - a_{k,k-1}u_{k+1} - a_{k,k}u_k ) = u_kw_k(u)
	\\
	.....		
	\\
	\dot{u_n} = u_n(-r_n + a_{n,n-1}u_{n-1} - a_{n,n}u_n ) = u_nw_n(u)
	\end{cases}
\)

Если система имеет единственное положение равновесия  \(p \in R^n \), тогда \(p\) является единственно представимой траекторией системы \((1)\), \(a_{ii} > 0\), \(i = \overline{1,n}\).
...
\begin{figure} [h!]
			\center{\includegraphics[width=0.8\textwidth]{ch9/IMG_5475.eps}}
...
\begin{figure} [h!]
			\center{\includegraphics[width=0.8\textwidth]{ch9/IMG_5476.eps}}
			\caption{Модель циклической конкуренции}	
\end{figure}
...
\)
\begin{figure} [h!]
			\center{\includegraphics[width=0.8\textwidth]{ch9/IMG_5477.eps}}
			\caption{Устойчивое вращение}	
\end{figure}
\begin{figure} [h!]
			\center{\includegraphics[width=0.8\textwidth]{ch9/IMG_5478.eps}}
			\caption{}	
\end{figure}
...
\begin{figure} [h!]
			\center{\includegraphics[width=0.8\textwidth]{ch9/IMG_5479.eps}}
...
\begin{figure} [h!]
			\center{\includegraphics[width=0.8\textwidth]{ch9/IMG_5480.eps}}
...
\)
\begin{figure} [h!]
			\center{\includegraphics[width=0.8\textwidth]{ch9/IMG_5481.eps}}
...
\end{center}
\begin{figure} [h!]
			\center{\includegraphics[width=0.8\textwidth]{ch9/IMG_5482.eps}}
			\caption{}	
\end{figure} 
...
\begin{figure} [h!]
			\center{\includegraphics[width=0.8\textwidth]{ch9/IMG_5483.eps}}
			\caption{}	
\end{figure}
